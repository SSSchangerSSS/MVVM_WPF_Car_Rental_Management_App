...
using ViewModels.Commands.CarCommands.AddCarViewModelCommands;
...
{
    /// <summary>
    /// <see cref="AddCarViewModel"/> class is a viewModel (dataContext) for add car view 
    /// </summary>
    public class AddCarViewModel : ViewModelBase, INotifyDataErrorInfo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddCarViewModel"/> class.
        /// </summary>
        ...
        public AddCarViewModel(ManagementStore managementStore, ICarRentalNavigationService navigationService)
        {
            SubmitCommand = new AddCarSubmitCommand(managementStore, navigationService, this);
